...
# unspecified (an less important) sources of variation
...
# 5. Repear steps (3) and (4) many times (typically n=1000). This will let us visualize as a histogram the distribution of x(sim); distribution of x valyues when the null hypothesis is true
...
# look at mean in two groups of randomized data
...
plot_ran_test <- function(z=NULL) {
  ...
  p2 <- p1 + geom_histogram(mapping=aes(fill=I("goldenrod"),
                      color=('black'))) +
