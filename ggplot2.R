# -----------------------------------
# ggplot multiple plots and aesthestics
# 22 Apr 2021
# EMD
# -----------------------------------
#
...
# / and | for intuidive plot layouts
(g1 | g2 | g3)/g4
...
# change the slyling of patchwork annocations
g1 + g2 +
  plot_annotation(
...
# Map two variable to different aesthetics
m1 <- ggplot(data=d,
             mapping=aes(x=displ,
                         y=cty,
                         shape=class,
...
# basic faceting with variable split by row, column or both
m1 <- ggplot(data=d,
             mapping=aes(x=displ,y=cty)) +
  geom_point()
...
# use aesthetic mapping to overide the defaults
