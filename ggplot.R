# -----------------------------------
# Basics of ggplot grammer and graphics
# 20 Apr 2021
# EMD
# -----------------------------------
#
...
#basic histogram
qplot(x=d$hwy)
qplot(x=d$hwy, fill=I('tan'), color=('black'))
...
# bar plot with specifid counts or means (short format)
...
qplot(x=my_vec,y=dgamma(my_vec,shape=5,scale=3), geom='line') # density function for stats
qplot(x=my_vec,y=my_fun(my_vec),geom='line') # user defined function

# Themes and fonts ------------------------------

p1 <- ggplot(data=d,
             mapping=aes(displ,y=cty)) +
  geom_point()
print(p1)
